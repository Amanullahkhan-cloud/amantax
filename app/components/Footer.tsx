        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              Pakistan&apos;s trusted tax consultancy firm. Simplifying taxes for individuals and businesses since 2009.
            </p>
            <div className="flex gap-4">
              ...
              {['facebook', 'twitter', 'linkedin', 'instagram'].map((social) => (
                <a
                  key={social}
                  href="#"
                  className="w-10 h-10 rounded-full bg-white/5 hover:bg-emerald-400/20 flex items-center justify-center transition-colors"
                  aria-label={social}
                >
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              <li className="flex gap-3">
                ...
                <span>T-348, 3rd Floor, Amma Tower,<br />Main MA Jinnah Road, Saddar,<br />Karachi, Pakistan</span>
              </li>
              <li className="flex gap-3">
                <svg className="w-5 h-5 text-emerald-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span>+92-343-1917698</span>
              </li>
              <li className="flex gap-3">
                <svg className="w-5 h-5 text-emerald-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
